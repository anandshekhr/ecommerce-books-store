...
urlpatterns = [
    ...
    path( 'items/book/variant', views.BookVariantAPI.as_view()),
    path( 'items/electronics/add', views.ElectronicPostAPI.as_view()),
    path( 'items/electronics/variant', views.ElectronicVariantAPI.as_view()),
    path( 'items/musical-instruments/add', views.MusicalInstrumentPostAPI.as_view()),
    path( 'items/musical-instruments/variant', views.MusicalInstrumentVariantAPI.as_view()),
